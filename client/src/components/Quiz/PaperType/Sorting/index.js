...
const Sorting = ({allQuestions,flag,handleFlag,handleNext,handleCheckBoxChange,sortingAnswer, handlePrev,handleSubmitAnswer,quesNo,paper}) => {
  return (
    <div>
      <div className="question-paper">
        ...
        {sortingAnswer && <div style={{marginTop: "1rem"}}>Your Order: {sortingAnswer}</div>}
