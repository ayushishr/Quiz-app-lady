...
const Multiple = ({ questionDetails, handleInputChange, addNewQuestion }) => {
  const navigate = useNavigate();
  return (
    <div className="question-form">
      <div className="question-container">
        <div className="question-header">
          <div className="question-text">Multiple Choice Question</div>
        ...
        <div className="question-submit-container">
          <div className="question-submit" onClick={addNewQuestion}>
            Add Question
          </div>
          <div
